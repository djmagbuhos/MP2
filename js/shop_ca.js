async function getData(data) {
  ...
  function generateProductCard(product) {
    const productCard =
      '<div class="col-lg-3 my-2"><div class="card card-products h-100"><a href="product_site/product_' +
      product.item_id +
      '.html"><img src="' +
      product.image_card +
      '" class="img-fluid card-img-top card_img_prod" alt="' +
      product.item_name +
      '"/></a><div class="card-body"><hr /><a class="card_name" href="product_site/product_' +
      product.item_id +
    ...
    $("#products_display").append(productCard);
...
getData("https://mp2-express-pebt.onrender.com/api/product");
